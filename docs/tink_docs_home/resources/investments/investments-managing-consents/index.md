...
source: "https://docs.tink.com/resources/investments/investments-managing-consents"
...
To list provider consents, you must generate a `user access token` with the scope `provider-consents:read`. For instructions on how to generate an access token, see [Get a user access token](https://docs.tink.com/resources/investments/investments-continuous-access-to-a-bank-account#get-a-user-access-token).
...
To generate the `authorization_code`, follow the steps in [Generate the code](https://docs.tink.com/resources/investments/investments-continuous-access-to-a-bank-account#generate-a-user-authorization-code-and-grant-user-access).
...
For more information on which parameters can be provided to the update-consent method in Tink Link, see [Update consent](https://docs.tink.com/resources/investments/investments-managing-consents).
...
To delete a user, you must generate a `user access token` with the scope `user:delete`. See step 4 of this [guide](https://docs.tink.com/resources/investments/investments-continuous-access-to-a-bank-account#get-a-user-access-token) for instructions on how to generate an access token.
