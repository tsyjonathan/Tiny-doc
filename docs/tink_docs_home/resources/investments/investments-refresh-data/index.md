...
source: "/Tiny-doc/tink_docs_home/resources/investments/investments-refresh-data/"
...
-   **Refresh successful:** The `statusUpdated` timestamp has changed, and the `status` is now `UPDATED`. You can now go ahead and fetch updated [list of investment accounts](/Tiny-doc/tink_docs_api/api/#data-v2/investment/list-investment-accounts) and [holdings](/Tiny-doc/tink_docs_api/api/#data-v2/investment/list-holdings).
...
If the refresh request ended in one of the `statuses` listed above for unsuccesful refreshes, then you will need to [direct the end user to **update their consent**](/Tiny-doc/tink_docs_home/resources/investments/investments-managing-consents/).
