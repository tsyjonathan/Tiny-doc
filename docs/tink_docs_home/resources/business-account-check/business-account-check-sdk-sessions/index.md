...
source: "/Tiny-doc/tink_docs_home/resources/business-account-check/business-account-check-sdk-sessions/"
exportedAt: "2026-01-13T12:44:44.767Z"
---
## Overview[](#overview)
...
```
https://link.tink.com/1.0/business-account-check/create-report?...&session_id={SESSION_ID}
```
...
-H 'Authorization: Bearer ' \ 
-H 'Content-Type: application/json' \ 
-d '{ "user" : "firstName": “Joe”, “lastName”: “Shmoe” }' 
```
