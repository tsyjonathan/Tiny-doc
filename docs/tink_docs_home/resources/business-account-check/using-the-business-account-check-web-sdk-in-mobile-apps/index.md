...
source: "/Tiny-doc/tink_docs_home/resources/business-account-check/using-the-business-account-check-web-sdk-in-mobile-apps/"
exportedAt: "2026-01-13T12:57:49.224Z"
---
    ...
    func application(_ app: UIApplication, open url: URL, options: [UIApplication.OpenURLOptionsKey: Any] = [:]) -> Bool {
        if url.host == "callback" {
            if let components = URLComponents(url: url, resolvingAgainstBaseURL: true)?.queryItems,
                let businessAccountVerificationReportId = components.first(where: { $0.name == "business_account_verification_report_id" })?.value {
