...
3.  Open the ZIP file and extract the file named `Business Account Check.postman_collection.json` to your computer.
...
3.  Open the Business Account Check JSON file that you have downloaded and extracted.
4.  Select **Import**.

The Postman collection for Business Account Check is now imported to Postman.
...
The Postman collection for Business Account Check contains documentation. The documentation contains prerequisites to get your API credentials, and a guide that shows you how to fetch data via our API to get an accounts list and transactions data.
