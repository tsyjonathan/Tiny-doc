...
source: "https://docs.tink.com/resources/business-account-check/business-account-check-sdk-reference"
...
| Parameter | Availability | Description |
| --- | --- | --- |
| `error` | Always | A status code that describes the category of the error. For details, see [error statuses](https://docs.tink.com/resources/business-account-check/handle-business-account-check-error-codes#error-statuses). |
| `error_reason` | Always | The error reason that describes the cause of the error. For details, see the error reasons for the respective [error status](https://docs.tink.com/resources/business-account-check/handle-business-account-check-error-codes#error-statuses). |
