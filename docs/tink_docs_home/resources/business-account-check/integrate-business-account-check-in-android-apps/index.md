---
title: "Integrate Business Account Check in Android apps"
source: "/Tiny-doc/tink_docs_home/resources/business-account-check/integrate-business-account-check-in-android-apps/"
exportedAt: "2026-01-13T12:44:31.544Z"
---
...
override fun onNewIntent(intent: Intent?) {
    ...
    intent?.data?.let { uri ->
        if (uri.host == "callback") {
            val businessAccountVerificationReportId = uri.getQueryParameter("business_account_verification_report_id")
            ... // Use `businessAccountVerificationReportId` to retrieve the report using your backend
        }
    }
}
```
