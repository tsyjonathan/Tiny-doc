...
source: "/Tiny-doc/tink_docs_home/resources/data-enrichment/webhook-for-enrichment-completed/"
exportedAt: "2026-01-13T12:48:20.491Z"
---
The Enrichment Completed Webhook lets you subscribe to an event that is generated when transaction enrichments are completed. To set up a webhook, see [Set up webhooks for your app](/Tiny-doc/tink_docs_home/resources/getting-started/webhooks/).
...
You can read more about it in our [Webhook API documentation](/Tiny-doc/tink_docs_api/api-events-v2/#events-v2/webhook).
...
Webhook model is described in the [Webhook API documentation](/Tiny-doc/tink_docs_api/api-events-v2/#events-v2/webhook/).
