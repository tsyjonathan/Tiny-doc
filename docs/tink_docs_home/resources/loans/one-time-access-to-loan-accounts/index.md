...
source: "https://docs.tink.com/resources/loans/one-time-access-to-loan-accounts"
...
If you want to experiment with Loans by using our API, try our [Postman collection for Loans](https://docs.tink.com/resources/investments/postman-collection-for-loans).
