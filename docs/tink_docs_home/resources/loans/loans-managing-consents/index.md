...
source: "/Tiny-doc/tink_docs_home/resources/loans/loans-managing-consents/"
...
For more information on which parameters can be provided to the update-consent method in Tink Link, see [Update consent](/Tiny-doc/tink_docs_home/resources/transactions/managing-consents/#update-a-consent).
...
To delete a user, you must generate a `user access token` with the scope `user:delete`. See step 4 of this [guide](/Tiny-doc/tink_docs_home/resources/transactions/continuous-connect-to-a-bank-account/#retrieve-user-data) for instructions on how to generate an access token.
