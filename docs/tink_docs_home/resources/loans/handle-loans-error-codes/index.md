...
source: "/Tiny-doc/tink_docs_home/resources/loans/handle-loans-error-codes/"
...
Something is wrong with the Tink Link URL, usually due to missing or incorrect parameters. For the full list of parameters and values, see the [Loans SDK reference](/Tiny-doc/tink_docs_home/resources/loans/loans-sdk-reference/).
