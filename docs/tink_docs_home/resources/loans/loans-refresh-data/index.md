...
source: "https://docs.tink.com/resources/loans/loans-refresh-data"
exportedAt: "2026-01-13T12:45:32.266Z"
---
...
-   **Refresh successful:** The `statusUpdated` timestamp has changed, and the `status` is now `UPDATED`. You can now go ahead and [list the loan accounts](https://docs.tink.com/api#data-v2/loan/list-loan-accounts).
