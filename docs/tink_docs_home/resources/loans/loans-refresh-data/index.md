...
source: "/Tiny-doc/tink_docs_home/resources/loans/loans-refresh-data/"
...
-   **Refresh successful:** The `statusUpdated` timestamp has changed, and the `status` is now `UPDATED`. You can now go ahead and [list the loan accounts](/Tiny-doc/tink_docs_api/api/#data-v2/loan/list-loan-accounts).
