---
title: "Loans SDK reference - Tink Docs"
source: "https://docs.tink.com/resources/loans/loans-sdk-reference"
exportedAt: "2026-01-13T12:45:44.963Z"
---
...
```
https://link.tink.com/1.0/products/connect-accounts?client_id=&products=LOANS,TRANSACTIONS&redirect_uri=http://localhost:3000/callback&market=GB
```
...
| Parameter | Availability | Description |
| --- | --- | --- |
| `error` | Always | A status code that describes the category of the error. For details, see [error statuses](https://docs.tink.com/resources/loans/handle-loans-error-codes#error-statuses). |
| `error_reason` | Always | The error reason that describes the cause of the error. For details, see the error reasons for the respective [error status](https://docs.tink.com/resources/loans/handle-loans-error-codes#error-statuses). |
...
```
https://link.tink.com/1.0/products/connect-accounts?client_id=&products=LOANS,TRANSACTIONS&redirect_uri=http://localhost:3000/callback&market=GB&authorization_code=d473ea2bea8f484c9d7889b0a
```
...
```
https://link.tink.com/1.0/products/update-consent?client_id=&products=LOANS,TRANSACTIONS&credentials_id=6915ab99857fec1e6f2f6c078&redirect_uri=http://localhost:3000/callback&authorization_code=d473ea2bea8f484c9d7889b0a
```
