...
source: "/Tiny-doc/tink_docs_home/resources/risk-insights/using-the-risk-insights-web-sdk-in-mobile-apps/"
exportedAt: "2026-01-13T12:58:18.380Z"
---
    ...
    func application(_ app: UIApplication, open url: URL, options: [UIApplication.OpenURLOptionsKey: Any] = [:]) -> Bool {
        if url.host == "callback" {
            if let components = URLComponents(url: url, resolvingAgainstBaseURL: true)?.queryItems,
                let riskInsightsId = components.first(where: { $0.name == "risk_insights_id" })?.value {
