...
source: "/Tiny-doc/tink_docs_home/resources/payments/payment-initiation-flow-optimisation-overview/"
exportedAt: "2026-01-13T12:53:55.532Z"
---
...
### "AIS +PIS" flow[](#quot-ais-pis-quot-flow)

![Flow optimization - generic - Overview](https://images.ctfassets.net/tmqu5vj33f7w/1uPHhwrHkHxLa3ra6oWWwF/a38b2cdcd9c56abb8c6da8db8d8b6442/AIS_PIS_flow.jpg) _Overview of the Payments flow where the source account is mandatory when initiating a payment (e.g. IT, SE, DE, NO, FI)_

### "PIS-only" flow[](#quot-pis-only-quot-flow)
...
Please note: when adjusting the colours and fonts you need to ensure the legal notices are clearly visible for all users.
