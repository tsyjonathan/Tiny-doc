...
source: "https://docs.tink.com/resources/payments/one-time-payments/initiate-your-first-bulk-payment"
...
[Make your first payment request](https://docs.tink.com/resources/payments/start-payment#create-a-payment-request)

[See the payment request API reference](https://docs.tink.com/api#payment/payment-request/create-payment-request)
...
[See the bulk payment request API reference](https://docs.tink.com/api-payment#payment/bulk-payment)
...
[See the Payments SDK reference](https://docs.tink.com/resources/tink-link-web/tink-link-web-api-reference-payment-initiation)

### Optimizing bank selection[](#optimizing-bank-selection)

If you know the user’s provider, and that provider supports bulk payments, then you can [skip the bank selection step](https://docs.tink.com/resources/payments/one-time-payments/payments-flow-optimization-bank-selection) of the payments flow by including the `input_provider` parameter in your Payments URL.

To see which providers support bulk payments, [query the providers endpoint](https://docs.tink.com/api-connectivity-v1#connectivity-v1/provider) using `pisCapabilities=PIS_BULK_PAYMENTS`.
...
If you know the user’s source account, you can [preselect the account](https://docs.tink.com/resources/payments/one-time-payments/payments-flow-optimization-source-account-preselection) using a Tink Link session.

If you know the user’s personal identifier, such as their social security number, you can [prefill this information](https://docs.tink.com/resources/payments/one-time-payments/consent-and-authentication-one-time-payments#initiating-authentication) using the same session.
...
[See the sessions API reference](https://docs.tink.com/api-general#general/tink-link/session)

## 4\. Initiate the bulk payment[](#initiate-the-bulk-payment)

When you’ve created a URL, [test it with the Demo Bank](https://docs.tink.com/resources/payments/one-time-payments/test-different-one-time-payment-scenarios#demo-bank).
...
[See the bulk payments API reference](https://docs.tink.com/api#payment/bulk-payment/get-bulk-payment)
