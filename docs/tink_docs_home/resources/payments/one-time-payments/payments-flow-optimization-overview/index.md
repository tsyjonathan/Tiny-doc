...
*Image removed: Flow optimization - generic - Overview* _Overview of the Payments flow where the source account is mandatory when initiating a payment (e.g. IT, SE, DE, NO, FI)_

### "PIS-only" flow[](#quot-pis-only-quot-flow)

*Image removed: Flow optimization - UK - Overview* _Overview of the Payments flow where the source account is chosen in the bank redirect (e.g. UK, FR, PT, ES)_
...
*Image removed: Flow optimization - theme (1)*
