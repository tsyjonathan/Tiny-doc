...
source: "https://docs.tink.com/resources/transactions/early-redirect"
...
1.  Exchange the authorization code (`code`) for a user access token as described in [Authenticate your client](https://docs.tink.com/resources/transactions/connect-to-a-bank-account#authenticate-your-client).
...
4.  Once the credentials are in an `UPDATED` state, you can proceed with [One-time access to a bank account](https://docs.tink.com/resources/transactions/connect-to-a-bank-account) or [Continuous access to a bank account](https://docs.tink.com/resources/transactions/continuous-connect-to-a-bank-account).
