...
source: "/Tiny-doc/tink_docs_home/resources/income-check/income-check-sdk-sessions/"
exportedAt: "2026-01-13T12:48:43.916Z"
---
## Overview[](#overview)
...
```
https://link.tink.com/1.0/income-check/create-report?...&session_id={SESSION_ID}
```
