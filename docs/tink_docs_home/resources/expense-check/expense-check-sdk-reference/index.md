...
source: "https://docs.tink.com/resources/expense-check/expense-check-sdk-reference"
...
| Parameter | Availability | Description |
| --- | --- | --- |
| `error` | Always | A status code that describes the category of the error. For details, see [error statuses](https://docs.tink.com/resources/expense-check/handle-expense-check-error-codes#error-statuses). |
| `error_reason` | Always | The error reason that describes the cause of the error. For details, see the error reasons for the respective [error status](https://docs.tink.com/resources/expense-check/handle-expense-check-error-codes#error-statuses). |
...
These are the markets supported for Expense Check. If a `market` isn't provided, Tink defaults to `SE`. See [market capabilities](https://docs.tink.com/market-capabilities) for all available providers by market.
