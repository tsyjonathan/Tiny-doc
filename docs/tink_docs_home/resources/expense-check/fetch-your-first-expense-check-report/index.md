...
In Console, use the Build your own Tink Link URL view to create your own URL. Your resulting URL is used to allow users to authenticate with their bank and select an account from which to fetch report data. For more information on how the URL works, see [Setup and integrate Expense Check](/Tiny-doc/tink_docs_home/resources/expense-check/setup-and-integrate-expense-check/).
