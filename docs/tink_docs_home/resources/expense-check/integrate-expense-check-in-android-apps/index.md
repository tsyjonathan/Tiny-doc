---
title: "Integrate Expense Check in Android apps"
source: "/Tiny-doc/tink_docs_home/resources/expense-check/integrate-expense-check-in-android-apps/"
exportedAt: "2026-01-13T12:49:03.648Z"
---
...
override fun onNewIntent(intent: Intent?) {
    ...
    intent?.data?.let { uri ->
        if (uri.host == "callback") {
            val expenseCheckId = uri.getQueryParameter("expense_check_id")
            ... // Use `expenseCheckId` to retrieve the report using your backend
        }
    }
}
```
