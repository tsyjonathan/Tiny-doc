...
source: "/Tiny-doc/tink_docs_home/resources/expense-check/expense-check-sdk-sessions/"
exportedAt: "2026-01-13T12:49:13.548Z"
---
## Overview[](#overview)
...
```
https://link.tink.com/1.0/expense-check/create-report?...&session_id={SESSION_ID}
```
