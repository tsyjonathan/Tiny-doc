...
source: "/Tiny-doc/tink_docs_home/resources/expense-check/using-the-expense-check-web-sdk-in-mobile-apps/"
exportedAt: "2026-01-13T12:58:15.608Z"
---
    ...
    func application(_ app: UIApplication, open url: URL, options: [UIApplication.OpenURLOptionsKey: Any] = [:]) -> Bool {
        if url.host == "callback" {
            if let components = URLComponents(url: url, resolvingAgainstBaseURL: true)?.queryItems,
                let expenseCheckId = components.first(where: { $0.name == "expense_check_id" })?.value {
