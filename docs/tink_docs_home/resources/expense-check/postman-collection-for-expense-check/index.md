...
This article shows how to use Tink's Postman collection for Expense Check. For documentation and help to use Postman, go to the Postman docs introduction

**Note**: Postman is a third-party company that makes an API platform for building and using APIs. To use the Postman collection for Expense Check, you must first either sign up for a Postman user account to use Postman or download and install their app.
