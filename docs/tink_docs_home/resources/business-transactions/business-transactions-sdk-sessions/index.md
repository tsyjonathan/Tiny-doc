...
source: "https://docs.tink.com/resources/business-transactions/business-transactions-sdk-sessions"
...
```
https://link.tink.com/1.0/business-transactions/connect-accounts?...&session_id={SESSION_ID}
```
