---
title: "Integrate Business Transactions in Android apps"
source: "/Tiny-doc/tink_docs_home/resources/business-transactions/integrate-business-transactions-in-android-apps/"
exportedAt: "2026-01-13T12:46:57.586Z"
---
...
override fun onNewIntent(intent: Intent?) {
    ...
    intent?.data?.let { uri ->
        if (uri.host == "callback") {
            ...
            ... // Use `code` to retrieve a user access token that can be used to access the business-transactions
        }
    }
}
```
