...
source: "https://docs.tink.com/resources/business-transactions/business-refresh-data"
...
To manage user data after a refresh, you can subscribe to webhooks for notifications on events. To learn more about subscribing and using these events, check out the [Webhooks for Business Transactions](https://docs.tink.com/resources/business-transactions/webhooks-for-business-transactions) article.
...
-   **Refresh successful:** The `statusUpdated` timestamp has changed, and the `status` is now `UPDATED`. You can now go ahead and [list transactions](https://docs.tink.com/resources/business-transactions/list-business-transactions).
...
If the refresh request ended in one of the statuses listed above for unsuccesful refreshes, you need to direct the end user to update their consent. For more information, see [Updating a consent](https://docs.tink.com/resources/business-transactions/business-managing-consents#updating-a-consent).
