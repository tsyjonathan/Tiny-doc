...
## List of NCAs for larger markets[](#list-of-ncas-for-larger-markets)
...
## Operating in other EU markets[](#operating-in-other-eu-markets)

To operate in other EU markets outside of your home market, you will need to “passport” your license to each host market you want to operate in.

This is a process that can only be done:

-   once you have received the license for your home market
-   and only through your local NCA (in other words, not directly with the NCA of the host country)

In your passporting application, make sure you include all services authorised under your local licence. These typically cover:

-   Payment Initiation Services (PIS)
-   Account Information Services (AIS) Including the complete scope of your licensed services prevents operational gaps when expanding across EU markets.
