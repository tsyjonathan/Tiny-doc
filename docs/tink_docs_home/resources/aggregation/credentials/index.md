...
The deeplink should have the following format: `bankid:///?autostarttoken=[TOKEN]&redirect=[RETURNURL]` The preferred way in iOS is the following format: `[external url removed]]&redirect=[RETURNURL]`
