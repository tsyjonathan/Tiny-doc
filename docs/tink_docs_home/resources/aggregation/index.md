...
### Aggregate data with Tink Link

Fetch financial data using Tink REST APIs.
...
Use the API to create bank credentials for a specific user and aggregate financial data into Tink.
...
Download and run our sample snapshot aggregation project using Tink Link Web.
...
Download and run our sample aggregation project with permanent users using Tink Link Web.
