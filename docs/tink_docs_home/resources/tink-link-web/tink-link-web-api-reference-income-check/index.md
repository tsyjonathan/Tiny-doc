---
title: "Tink Link Reference (Income Check)"
source: "https://docs.tink.com/resources/tink-link-web/tink-link-web-api-reference-income-check"
exportedAt: "2026-01-13T12:59:37.701Z"
---
...
| engine\_version | Optional | Explicitly choose the version of the Income Check engine. |
...
```
https://link.tink.com/1.0/income-check/create-report?client_id={YOUR_CLIENT_ID}&redirect_uri=http://localhost:3000/callback&market=GB&external_reference=202001010101
```
...
| Parameter | Required | Description |
| --- | --- | --- |
| income\_check\_id | Required | Identifier that can be used to retrieve the generated income check report. |
