---
title: "Tink Link Reference (Business Transactions)"
source: "https://docs.tink.com/resources/tink-link-web/tink-link-web-api-reference-business-transactions"
exportedAt: "2026-01-13T12:59:45.255Z"
---
...
| refreshable\_items | Optional (defaults to all) | A comma separated list of refreshable items to include (`CHECKING_ACCOUNTS`, `CHECKING_TRANSACTIONS`, `SAVING_ACCOUNTS`, `SAVING_TRANSACTIONS`, `CREDITCARD_ACCOUNTS`, `CREDITCARD_TRANSACTIONS`) |
| financial\_services\_segments | Optional (default `PERSONAL,BUSINESS`) | A comma separated list of financial services segments (`PERSONAL`, `BUSINESS`). |
