---
title: "Tink Link Reference (Risk Insights)"
source: "https://docs.tink.com/resources/tink-link-web/tink-link-web-api-reference-risk-insights"
exportedAt: "2026-01-13T12:59:48.138Z"
---
...
## Create Risk insights Report[](#create-risk-insights-report)
...
```
https://link.tink.com/1.0/risk-insights/create-report?client_id={YOUR_CLIENT_ID}&redirect_uri=http://localhost:3000/callback&market=SE&external_reference=202001010101
```
...
| Parameter | Required | Description |
| --- | --- | --- |
| risk\_insights\_id | Required | Identifier that can be used to retrieve the generated risk insights report. |
