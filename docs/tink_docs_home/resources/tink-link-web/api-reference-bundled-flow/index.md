...
source: "https://docs.tink.com/resources/tink-link-web/api-reference-bundled-flow"
...
| refreshable\_items | Optional | A comma-separated list of [refreshable items](https://docs.tink.com/api#connectivity-v1/credentials/create-credentials/query-parameters) to include in this reports flow. The default will include refreshable items based on the bundled products. |
