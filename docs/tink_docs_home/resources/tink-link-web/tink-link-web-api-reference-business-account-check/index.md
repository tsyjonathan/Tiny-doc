---
title: "Tink Link Reference (Business Account Check)"
source: "https://docs.tink.com/resources/tink-link-web/tink-link-web-api-reference-business-account-check"
exportedAt: "2026-01-13T12:59:34.766Z"
---
...
Create a Business Account Check report.
...
```
https://link.tink.com/1.0/business-account-check/create-report?client_id={YOUR_CLIENT_ID}&redirect_uri=http://localhost:3000/callback
```
...
| Parameter | Required | Description |
| --- | --- | --- |
| business\_account\_verification\_report\_id | Required | Identifier that can be used to retrieve the generated business account verification report. |
...
```
{
  type: 'business_account_verification_report_id',
