---
title: "Integrate Account Check in Android apps"
source: "https://docs.tink.com/resources/account-check/integrate-account-check-in-android-apps"
exportedAt: "2026-01-13T12:43:36.935Z"
---
...
override fun onNewIntent(intent: Intent?) {
    ...
    intent?.data?.let { uri ->
        if (uri.host == "callback") {
            val accountVerificationReportId = uri.getQueryParameter("account_verification_report_id")
            ... // Use `accountVerificationReportId` to retrieve the report using your backend
        }
    }
}
```
