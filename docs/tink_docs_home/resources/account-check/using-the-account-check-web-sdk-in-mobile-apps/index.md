...
source: "/Tiny-doc/tink_docs_home/resources/account-check/using-the-account-check-web-sdk-in-mobile-apps/"
exportedAt: "2026-01-13T12:57:40.999Z"
---
    ...
    func application(_ app: UIApplication, open url: URL, options: [UIApplication.OpenURLOptionsKey: Any] = [:]) -> Bool {
        if url.host == "callback" {
            if let components = URLComponents(url: url, resolvingAgainstBaseURL: true)?.queryItems,
                let accountVerificationReportId = components.first(where: { $0.name == "account_verification_report_id" })?.value {
