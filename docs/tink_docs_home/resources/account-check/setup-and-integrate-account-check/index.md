...
source: "https://docs.tink.com/resources/account-check/setup-and-integrate-account-check"
...
You will first need to construct a URL to launch the SDK flow. In [Console](https://console.tink.com/), you can use the [Tink Link visual editor](https://console.tink.com/account-verification/tink-link) to easily create and configure the end-user flow. For a list of all possible request and response parameters, see the [Account Check SDK reference](https://docs.tink.com/resources/account-check/account-check-sdk-reference). The resulting URL is used to launch the SDK flow, allowing the user to authenticate with their bank and select an account that will be used to generate the account verification report.
...
See the [Account Check SDK reference](https://docs.tink.com/resources/account-check/account-check-sdk-reference) for success and error response formats and their parameters.

To successfully integrate the web SDK in a mobile app, see [using the web SDK in mobile apps](https://docs.tink.com/resources/account-check/using-the-account-check-web-sdk-in-mobile-apps).

### API Reference[](#api-reference)

For the full reference documentation, see the [Account Check SDK reference](https://docs.tink.com/resources/account-check/account-check-sdk-reference).
