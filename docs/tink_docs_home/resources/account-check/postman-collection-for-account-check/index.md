...
source: "/Tiny-doc/tink_docs_home/resources/account-check/postman-collection-for-account-check/"
exportedAt: "2026-01-13T12:43:54.691Z"
---
...
This article shows how to use Tink's Postman collection for Account Check. For documentation and help to use Postman, go to the [Postman docs introduction](https://learning.postman.com/docs/getting-started/introduction/)

**Note**: Postman is a third-party company that makes an API platform for building and using APIs. To use the Postman collection for Account Check, you must first either [sign up for a Postman user account](https://www.postman.com/) to use Postman or download and install their app.
...
3.  Open the ZIP file and extract the file named `AccountCheck.postman_collection.json` to your computer.
...
3.  Open the Account Check JSON file that you have downloaded and extracted.
4.  Select **Import**.
